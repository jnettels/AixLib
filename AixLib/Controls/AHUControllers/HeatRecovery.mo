...
model HeatRecovery "Controller of a heat recovery unit"
  ...
  Continuous.LimPID pIController(
    controllerType=Modelica.Blocks.Types.SimpleController.PI,
    k=0.5,
    Ti=100) annotation (Placement(transformation(extent={{62,-69},{78,-51}})));
...
equation
  ...
  connect(switch2.y, pIController.u_m) annotation (Line(points={{51,-50},{56,-50},
          {56,-76},{70,-76},{70,-70.8}}, color={0,0,127}));
  connect(switch3.y, pIController.u_s) annotation (Line(points={{51,-82},{54,-82},
          {54,-60},{60.4,-60}}, color={0,0,127}));
  connect(pIController.y, switch1.u1)
    annotation (Line(points={{78.8,-60},{90,-60},{102,-60}}, color={0,0,127}));
